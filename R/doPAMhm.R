doPAMhm <-
		function(dat, folder.name = ".", nsheets = 1, symbolcol = 1, startcol = 2,
				sample.names = NULL, cluster.number = as.character(4), trim = -1,
				...
				log.base = 2, metric = "manhatten", makeFolder = TRUE, PDF = TRUE,
...
# the same file
	if (shiny) {
		plot.PAM(clustlist[[1]], names(clustlist)[1], res.folder = resultsFolder, col = plotCol,
